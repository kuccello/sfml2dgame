...
struct AircraftMover
{
	...
	void operator() (Aircraft& aircraft, sf::Time) const // this is possible because of the derivedAction adapter (see ch.4-command based communication)
	{
